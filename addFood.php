...
$sql_select = 'select * from food order by F_ID';
$stmt_s = $conn->prepare($sql_select);
$stmt_s->execute();

if (isset($_POST['submit'])) {
    
    if (!empty($_POST['F_ID']) && !empty($_POST['F_Name'])) {
        echo '<br>' . $_POST['F_ID'];
        //require 'connect.php';

        $sql = "INSERT INTO food VALUES (:F_ID, :F_Name, :F_Price)";
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4"> <br>
            ...
            <input type="text" placeholder="Enter Food ID" name="F_ID"> 
            <br> <br>
            <input type="text" placeholder="Name" name="F_Name">
            <br> <br>    
            <input type="number" placeholder="Price" name="F_Price">
            <br> <br> 
